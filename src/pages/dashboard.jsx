...
export default function Dashboard() {
  ...
  return (
    <div className="page">
      ...
      {/* ===== MAIN (TWO-CONTAINER LAYOUT — SAME AS BEFORE) ===== */}
      <div
        style={{
          display: "grid",
      ...
      >
        ...
        {/* ===== LEVEL CARDS (RIGHT — SAME STYLE) ===== */}
        <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
          {[
            { label: "Beginner Level 1", route: "/level/beginner-1" },
            { label: "Beginner Level 2", route: "/level/beginner-2" },
            { label: "Intermediate Level 1", route: "/level/intermediate-1" },
            { label: "Intermediate Level 2", route: "/level/intermediate-2" },
            { label: "Advanced Level", route: "/level/advanced" }
          ].map((level) => (
            <div
              key={level.route}
              className="card"
      ...
      >
        ...
        {!loadingProgress && Object.keys(progress).length === 0 && (
